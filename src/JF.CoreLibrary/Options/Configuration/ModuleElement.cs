...
namespace JF.Options.Configuration
{
	public class ModuleElement : OptionConfigurationElement
	{
		...
		public JF.ComponentModel.IApplicationModule CreateModule()
		{
			...
			if(!typeof(JF.ComponentModel.IApplicationModule).IsAssignableFrom(type))
			{
			...
			return Activator.CreateInstance(type) as JF.ComponentModel.IApplicationModule;
		}
