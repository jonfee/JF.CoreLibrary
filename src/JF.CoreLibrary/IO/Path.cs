...
namespace JF.IO
{
	...
	///		<list type="bullet">
	///			<item>
	///				<term>某个文件的<see cref="Url"/>：newlife:/data/attachments/2014/07/file-name.ext</term>
	///			</item>
	///			<item>
	///				<term>某个本地文件的<see cref="Url"/>：JF.local:/data/attachments/2014/07/file-name.ext</term>
	///			</item>
	///			<item>
	///				<term>某个分布式文件的<see cref="Url"/>：JF.distributed:/data/attachments/file-name.ext</term>
	///			</item>
	///			<item>
	///				<term>某个目录的<see cref="Url"/>：newlife:/data/attachments/2014/07/</term>
	///			</item>
	///			<item>
