...
namespace JF.IO
{
	...
	public class StorageFileInfo : MarshalByRefObject
	{
		...
		public static StorageFileInfo FromDictionary(IDictionary dictionary)
		{
			...
			var result = new StorageFileInfo(JF.Common.Convert.ConvertValue<int>(bucketId), JF.Common.Convert.ConvertValue<Guid>(fileId))
			{
				Name = JF.Common.Convert.ConvertValue<string>(name), Type = JF.Common.Convert.ConvertValue<string>(type), Size = JF.Common.Convert.ConvertValue<long>(size), Path = JF.Common.Convert.ConvertValue<string>(path), TotalVisits = JF.Common.Convert.ConvertValue<int>(totalVisits), CreatedTime = JF.Common.Convert.ConvertValue<DateTime>(createdTime), ModifiedTime = JF.Common.Convert.ConvertValue<DateTime?>(modifiedTime), VisitedTime = JF.Common.Convert.ConvertValue<DateTime?>(visitedTime),
			};
