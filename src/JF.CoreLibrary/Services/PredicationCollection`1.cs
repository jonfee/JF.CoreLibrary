...
{
	public class PredicationCollection<T> : JF.Collections.Collection<IPredication<T>>, IPredication<T>
	{
		#region 成员字段
		...
		{
			return JF.Common.Convert.TryConvertValue<T>(parameter, out result);
		}
