	...
	public class GuidConverter : System.ComponentModel.GuidConverter
	{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			if(value is byte[])
			{
				...
				if(array.Length > 16)
				{
					return new Guid(BitConverter.ToUInt32(array, 0), BitConverter.ToUInt16(array, 4), BitConverter.ToUInt16(array, 6), array[8], array[9], array[10], array[11], array[12], array[13], array[14], array[15]);
				}
			}
		...
		public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
		{
			...
			{
				ConstructorInfo ctor = typeof(Guid).GetConstructor(new Type[]
				{
					typeof(string)
				});
