...
namespace JF.ComponentModel
{
	public class EnumConverter : System.ComponentModel.EnumConverter
	{
		...
		private JF.Common.EnumEntry[] _entries;
		...
		{
			if(sourceType == typeof(string) || sourceType == typeof(DBNull) || sourceType == typeof(byte) || sourceType == typeof(sbyte) || sourceType == typeof(short) || sourceType == typeof(ushort) || sourceType == typeof(int) || sourceType == typeof(uint) || sourceType == typeof(long) || sourceType == typeof(ulong) || sourceType == typeof(decimal) || sourceType == typeof(double) || sourceType == typeof(float))
			{
				return true;
			}
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			...
			{
				return JF.Common.Convert.GetDefaultValue(this.EnumType);
			}
