...
namespace JF.Resources
{
	...
	public static class ResourceUtility
	{
		...
		/// <remarks>
		///		<para>
		///		譬如<paramref name="baseName"/>参数为：JF.EAS.Web，则返回的数组元素分别为：
		///		<list type="number">
		///			<item>
		///				<term>JF.EAS.Web</term>
		///			</item>
		///			<item>
		///				<term>JF.EAS.Web.Resources</term>
		///			</item>
		///			<item>
		///				<term>JF.EAS.Web.Properties.Resources</term>
		///			</item>
		///			<item>
		///				<term>JF.EAS</term>
		///			</item>
		///			<item>
		///				<term>JF.EAS.Resources</term>
		///			</item>
		///			<item>
		///				<term>JF.EAS.Properties.Resources</term>
		///			</item>
		///			<item>
		///				<term>Newlife</term>
		///			</item>
		///			<item>
		///				<term>JF.Resources</term>
		///			</item>
		///			<item>
		///				<term>JF.Properties.Resources</term>
		///			</item>
		///		</list>
		///		</para>
		/// </remarks>
