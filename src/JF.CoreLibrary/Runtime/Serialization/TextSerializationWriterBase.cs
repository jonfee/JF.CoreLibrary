...
namespace JF.Runtime.Serialization
{
	public abstract class TextSerializationWriterBase : ISerializationWriter
	{
		...
		protected virtual bool GetDirectedValue(object value, out string valueText)
		{
			...
			bool isDirectedValue = valueType.IsPrimitive || valueType.IsEnum || valueType == typeof(decimal) || valueType == typeof(DateTime) || valueType == typeof(DBNull) || valueType == typeof(object) || valueType == typeof(string) || valueType == typeof(Guid) || typeof(Type).IsAssignableFrom(valueType);
